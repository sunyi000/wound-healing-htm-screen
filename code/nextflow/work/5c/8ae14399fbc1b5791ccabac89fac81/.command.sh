...
"fiji" --ij2 --headless --run "../groovy/src/main/measureWoundClosing.groovy" 'inputDir="../../data/input",datasetId="C4ROI1_Fast",threshold="25",outDirName="output--fiji",headless="true",saveResults="true"'
