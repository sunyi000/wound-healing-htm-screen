...
"fiji" --ij2 --headless --run "../groovy/src/main/measureWoundClosing.groovy" 'inputDir="../../data/input",datasetId="A3ROI2_Slow",threshold="25",outDirName="output--fiji",headless="true",saveResults="true"'
