...
"/Users/tischer/Desktop/Fiji/Fiji.app/Contents/MacOS/ImageJ-macosx" --ij2 --headless --run "../groovy/src/main/measureWoundCosing.groovy" 'inputDir="../../data/input",datasetId="A3ROI2_Slow",threshold="25",outDirName="output",headless="true",saveResults="true"'
