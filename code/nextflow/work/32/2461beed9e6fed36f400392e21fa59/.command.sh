...
"/Users/tischer/Desktop/Fiji/Fiji.app/Contents/MacOS/ImageJ-macosx" --ij2 --headless --run "~/Documents/wound-healing-htm-screen/code/groovy/src/main/measureWoundClosing.groovy" 'inputDir="../../data/input",datasetId="A3ROI2_Slow",threshold="25",outDirName="output",headless="true",saveResults="true"'
